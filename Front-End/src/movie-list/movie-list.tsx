...
function MovieList()
{
    ...
    <div className="row">
        <div className="col">
            ...
            <Link to={"/add"} id="addButton" className="btn btn-primary mb-1"><i className="fa-solid fa-circle-plus"></i> Add Movie</Link>
                      ...
                      movies.map((movie: MovieModel, index: number) =>{
                        return(
                                ...
                                <tr key="{index}">
                                    ...
                                    <td className="text-center"><button onClick={()=>{confirmDelete(movie._id)}} className="btn btn-danger btn-sm delete"><i className="fa-solid fa-trash-can"></i> Delete</button></td>
                                </tr>
                        );
                      })
                    }
